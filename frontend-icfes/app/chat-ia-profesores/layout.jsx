...
export default function ChatIAProfesoresLayout({ children }) {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex flex-col lg:flex-row min-h-0">
        ...
        {/* PAGE CONTENT */}
        <main className="container max-w-2xl mx-auto px-2 flex-1 flex flex-col overflow-hidden min-h-0 lg:pt-0">
          {children}
        </main>

        {/* TOPHEADER PC */}
        <aside className="hidden lg:flex lg:w-1/3 lg:items-start lg:justify-start flex-col gap-4 px-4">
          <TopHeaderRight />
